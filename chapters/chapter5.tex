...
\begin{figure}[!htb]
    ...
    The behaviour is not critical, and the increasing of autocorrelation is suppressed with an increasing number of cluster updates per iteration.}
...
The biased values showed in Figure \ref{fig:local_cont_energy} are here on the same line as the other points.
