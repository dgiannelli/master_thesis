...
The results of the cluster algorithm, however, are be definitely better.

In Figure \ref{fig:cluster_energy_cont} are reported the values for the plaquette energy in the fixed physical volume line.
The biased values showed in \ref{fig:cont_energy_cont} are here on the same line of the other points.
