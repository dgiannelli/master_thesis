...
\tikzset{->-/.style={decoration={markings,mark=at position .6 with {\arrow{to}}},postaction={decorate}}} 
%\begin{figure}[!htb]
%    \centering
%    \begin{tikzpicture}[x=0.05\textwidth,y=0.05\textwidth]
%        \draw[step=1, help lines] (0,0) grid (5,5);
%        \draw[->-,very thick,blue] (1,4) -- (1,3);
%
%        \draw[->,very thick,green] (2,2) -- (1,2);
%        \draw[->,very thick,green] (1,2) -- (1,1);
%        \draw[->,very thick,green] (1,1) -- (2,1);
%
%        \draw[->,very thick,red] (3,2) -- (4,2);
%        \draw[->,very thick,red] (4,2) -- (4,3);
%        \draw[->,very thick,red] (4,3) -- (3,3);
%        \draw[->,very thick,red] (3,3) -- (3,2);
%
%        \draw[->,thick,blue] (-1.5,3.5) node[anchor=east] {Link} -- (0.5,3.5);
%        \draw[->,thick,green] (-1.5,1.5) node[anchor=east] {Staple} -- (0.5,1.5);
%        \draw[->,thick,red] (6.5,2.5) node[anchor=west] {Plaquette} -- (4.5,2.5);
%    \end{tikzpicture}
%    \caption{Useful objects in the discretized space-time}
%    \label{figLattice}
%\end{figure}
...
The site $s + \hat\mu$, with $\hat\mu = \hat1,\hat2$, corresponds to the point that has the $\mu$th coordinate increased by one.
...
\begin{figure}[!htb]
    ...
    \begin{tikzpicture}[x=1cm,y=1cm]
        \draw[step=1, help lines, dashed, color=black!30] (0,0) grid (5,3);
        \draw[->,very thick,black] (0,0) -- (5.5,0) node [right] {$x_1$};
...
\begin{figure}[!htb]
    \centering
    \begin{tikzpicture}[x=1cm,y=1cm]
        \draw[step=1, help lines, dashed, color=black!30] (0,0) grid (6,3);
        \draw[->,very thick,black] (0,0) -- (6.5,0) node [right] {$x_1$};
        \draw[->,very thick,black] (0,0) -- (0,3.5) node [above] {$x_2$};
...
\begin{figure}[!htb]
    ...
    \begin{tikzpicture}[x=1.5cm,y=1.5cm]
        \draw[step=1, help lines, dashed, color=black!30] (0,0) grid (5,2);
        \draw[->,very thick,black] (0,0) -- (5.5,0) node [right] {$x_1$};
        \draw[->,very thick,black] (0,0) -- (0,2.5) node [above] {$x_2$};
