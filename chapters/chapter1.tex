...
Numerical studies are usually performed with dimensionless parameters, because it simplifies the implementation and result comparisons.
...
To easily implement gauge invariance, it is useful to encapsulate gauge fields inside \emph{Wilson lines}:
\[
    U(x,y) = 
\]
